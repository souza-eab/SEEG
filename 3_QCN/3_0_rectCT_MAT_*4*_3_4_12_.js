...
// Import LCLUC data
var qcn = ee.Image("projects/mapbiomas-workspace/SEEG/2021/QCN_stp1/mat_4");
...
Export.image.toAsset({
    ...
    "description": 'ma_pclass_static_4_all',
    "assetId": dir_output + 'ma_pclas_static_4_all',
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
...
Export.image.toAsset({
    ...
    "description": 'ma_pclass_accumm_4_all',
    "assetId": dir_output + 'ma_pclas_accum_4_all',
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
