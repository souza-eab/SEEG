...
// Import LCLUC data
var qcn = ee.Image("projects/mapbiomas-workspace/SEEG/2021/QCN_stp1/caa_4");
...
list_classes.forEach(function(class_i) {
  ...
  list_mapb_years.forEach(function(year_j){
   ...
   // perform QCN correction by brazilian state - cumulative - considers the rect of the last year //
    ...
    image_static = image_static.addBands(ca_tot_rect);
...
Export.image.toAsset({
    ...
    "description": 'ca_pclass_static_4_all',
    "assetId": dir_output + 'ca_pclas_static_4_all',
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
...
Export.image.toAsset({
    ...
    "description": 'ca_pclass_accumm_4_all',
    "assetId": dir_output + 'ca_pclas_accum_4_all',
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
