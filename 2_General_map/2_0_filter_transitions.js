...
Export.image.toAsset({
    ...
    "assetId": 'users/edrianosouza/2021/Seeg-9/Regen_SEEGc6_1', //insere o endereço para onde vai exportar a máscara filtrada
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
...
Export.image.toAsset({
    ...
    "assetId": 'users/edrianosouza/2021/Seeg-9/DesmSEEGc6_2', //insere o endereço para onde vai exportar a máscara filtrada
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
