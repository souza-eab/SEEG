...
def start(years):
    ...
    transitions = ee.Image(
        'projects/mapbiomas-workspace/SEEG/2020/transicoes-c5-v1-img')
    ...
    name = "seeg-collection-5-transicao-biomas-municipios-" + \
        years[0] + '-' + years[1]

    task = ee.batch.Export.table.toDrive(
        collection=areas,
        description=name,
        folder='SEEG', #Pasta no Google Drive para exportar a tabela
        fileNamePrefix=name,
        fileFormat="GeoJSON")
